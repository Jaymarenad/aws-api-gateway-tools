---
title: STAN assistant guide (aws-api-gateway-tools)
---

# STAN assistant guide: @karmaniverous/aws-api-gateway-tools
...
import {
  ...
  secretsPlugin,
} from '@karmaniverous/aws-api-gateway-tools';
```
...
For complete usage examples, see the [AwsSecretsManagerTools guide](./aws-api-gateway-tools.md).
...
- Full programmatic reference: see the [AwsSecretsManagerTools guide](./aws-api-gateway-tools.md).
