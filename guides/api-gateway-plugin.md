...
If you want the programmatic API instead, see the [AwsSecretsManagerTools guide](./aws-api-gateway-tools.md).
...
import { secretsPlugin } from '@karmaniverous/aws-api-gateway-tools';
...
aws-api-gateway-tools aws secrets push -s my-secret --from file:global:public

# Allow both file and config layers (effective entry only)
aws-api-gateway-tools aws secrets push -s my-secret --from file:*:* --from config:*:*:*
```
...
- Programmatic API: see the [AwsSecretsManagerTools guide](./aws-api-gateway-tools.md).
