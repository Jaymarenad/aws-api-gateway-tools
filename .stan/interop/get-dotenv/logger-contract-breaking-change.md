...
This repo (aws-api-gateway-tools) integrates get-dotenv with AWS SDK v3. We have a recurring mismatch:
...
## Code to transfer from aws-api-gateway-tools (source of truth)
